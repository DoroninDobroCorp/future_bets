...
const $onlineUnMatchTeamPrematch = createStore<IUnMatchTeam[] | null>(null)
export const setUnMatchTeam = createEvent<IUnMatchTeam[] | null>()
export const deleteTeam = createEvent<string>()

export default $onlineUnMatchTeamPrematch
...
export class OnlineUnMatchTeamPrematchStore {
    static async getUnMatchTeams(sport: string, bookmaker1: string, bookmaker2: string): Promise<[IUnMatchTeam[] | null, number]> {
        return await TeamService.getOnlineUnMatchTeamPrematch(sport, bookmaker1, bookmaker2)
            .then((res) => {
