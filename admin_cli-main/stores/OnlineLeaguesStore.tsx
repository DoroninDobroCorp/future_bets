...
export class OnlineLeagueStore {
    static async getLeagues(sport: string, bookmaker1: string, bookmaker2: string): Promise<[ILeague[] | null, number]> {
        return await LeaguesService.getOnlineUnMatchLeagues(sport, bookmaker1, bookmaker2)
            .then((res) => {
